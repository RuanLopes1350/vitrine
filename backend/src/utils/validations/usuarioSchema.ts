...
const UsuarioSchema = z.object({
    nome: z.string({message: 'Campo nome é obrigatório.'})
        .min(3, 'Campo nome deve conter pelo menos 3 caracteres.'),
    ...
    senha: z.string({message: 'A senha deve ter pelo menos 8 caracteres.'})
        ...
        .regex(senhaRegex, 'A senha deve conter pelo menos 1 letra maiúscula, 1 letra minúscula, 1 número e no mínimo 8 caracteres.'),
    fotoPerfil: z.string()
        .url('URL da foto de perfil inválida').optional(),
    ativo: z.boolean()
        .optional()
        .default(true)
})
