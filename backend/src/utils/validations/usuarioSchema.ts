...
const UsuarioSchema = z.object({
    ...
    whatsapp: z.string({message: 'Campo whatsapp é obrigatório.'}).min(12, 'Campo whatsapp deve conter pelo menos 10 caracteres.').max(13, 'Campo whatsapp deve conter no máximo 11 caracteres.'),
