            ...
            <div className="w-[448px] h-[301px] text-[#111827]">
                ...
                <div className="flex flex-col gap-8">
                    <div className="border-2 border-[#D1D5DB] rounded-md gap-0 overflow-hidden">
                        ...
                        <Input type="password" placeholder="Senha" className="w-[448px] h-[38px] border-[#D1D5DB] rounded-none focus-visible:ring-0 focus-visible:ring-offset-0" />
                    </div>
                    <Link href="/esqueci-minha-senha-a" className="text-[#2563EB]">Esqueceu sua senha?</Link>
                    <Button className="w-[448px] h-[38px] bg-[#2563EB] text-white cursor-pointer">Entrar</Button>
                </div>
            </div>
        </div>
    )
