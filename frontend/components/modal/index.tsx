        ...
        >
            <div className="w-lg h-[658px]">
                <div className="flex flex-col gap-4 p-0">
                    ...
                    <div className="flex flex-row  gap-0.5 ml-[24px]">
                    ...
                    <input data-testid="modal-input-nome" type="text" id="input1" placeholder="Insira o nome do produto" className="ml-[24px]" />
                    <div className="flex flex-row ml-[24px] gap-0.5">
                    ...
                    <input data-testid="modal-input-descricao" type="text" id="input2" placeholder="Insira a descrição do produto" className="ml-[24px]" />
                    <div className="flex flex-row ml-[24px] gap-0.5">
                    ...
                    />
                    {imagePreview && (
                        <div data-testid="modal-preview-imagem" className="border-1 h-[202px] w-[400px] overflow-hidden ml-[24px]">
                            <img
                ...
                <button data-testid="modal-botao-principal" onClick={() => { handlePrimaryAction(); setImagePreview(''); }} className={button1.className}>{button1.texto}</button>
                {button2 && <button data-testid="modal-botao-secundario" onClick={() => { handleSecondaryAction(); setImagePreview(''); }} className={button2.className}>{button2.texto}</button>}
            </div>
        </dialog>
    )
}